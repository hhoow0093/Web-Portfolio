        ...
        <div className="nav-header container-fluid">
          ...
          {showText && (
            <p className="fixed-title">
              <a href="#Hero">My Portfolio Web</a>
            </p>
          )}
        </div>
        <div className="my-navigation container-fluid">
          <ul className="my-unordered-list">
            <li>
              ...
              {showText && <a href="#about-me">About me</a>}
            </li>
            <li>
              <a href="#value">
                <span className="my-icon">
              ...
              {showText && <a href="#value">My Value</a>}
            </li>
            <li>
              <a href="#timeline">
                <span className="my-icon">
              ...
              {showText && <a href="#timeline">Timeline</a>}
            </li>
            <li>
              <a href="#portfolio">
                <span className="my-icon">
              ...
              {showText && <a href="#portfolio">Portfolio</a>}
            </li>
          </ul>
        </div>
        <div className="my-navigation-footer container-fluid">
          <div className="row  my-footer-nav py-3">
            <div className="my-col col-4">
              <a href="mailto:howard@student.umn.ac.id">
                <span className="my-icon">
                  <svg
                    className="add-glow"
                    xmlns="http://www.w3.org/2000/svg"
            ...
            <div className="my-col col-8 d-flex align-items-end">
              {showText && (
                <a
                  href="mailto:howard@student.umn.ac.id"
